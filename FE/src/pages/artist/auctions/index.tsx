...
const SellerAuctionsRoute: NextPageWithLayout = () => {
...
SellerAuctionsRoute.getLayout = (page) => <SidebarLayout hideFooter>{page}</SidebarLayout>

export default SellerAuctionsRoute
