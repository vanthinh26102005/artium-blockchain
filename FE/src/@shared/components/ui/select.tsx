...
>(({ className, children, ...props }, ref) => (
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-[44px] w-full items-center justify-between gap-1 rounded-[8px] border border-input bg-background px-3 py-2 text-sm outline-none ring-offset-background focus:border-2 focus:border-[#0F6BFF] disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-black/[.3] [&>span]:line-clamp-1',
      className,
      /**
