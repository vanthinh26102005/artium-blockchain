...
const FormLabel = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof LabelPrimitive.Root> & { required?: boolean; tooltip?: any }
    ...
    >
      ...
      {tooltip && (
        <TooltipProvider>
          <Tooltip>
            {/* tooltip trigger */}
            <TooltipTrigger className="ml-1 cursor-default align-middle text-black">
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <p
      ...
      className={cn('text-xs text-[#767676]', className)}
      {...props}
    />
  )
})
