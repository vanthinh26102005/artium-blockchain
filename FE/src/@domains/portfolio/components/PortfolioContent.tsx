 ...
 */
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className={`flex items-center gap-4 rounded-xl border bg-white p-4 transition-all hover:shadow-md ${item.visible ? 'border-slate-200' : 'border-dashed border-slate-300 opacity-60'
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                    ...
                    <Pencil className="h-3.5 w-3.5 text-slate-400 cursor-pointer hover:text-slate-600" />
                </div>
 ...
 */
                ...
                <Button variant="outline" className="flex items-center justify-center gap-2 border-slate-200 h-11">
            ...
            {/* Statement Section */}
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 className="text-xl font-bold text-slate-900 text-center mb-1">Statement</h2>
                <p className="text-sm text-slate-500 text-center mb-4">Share the story behind your works.</p>
                ...
                <div className="space-y-2">
                    <div className="relative">
                        ...
                        />
                        <Pencil className="absolute top-3 right-3 h-4 w-4 text-slate-400" />
                    </div>
                    <p className="text-xs text-slate-400 text-right">
            ...
            {/* Artworks Section */}
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 className="text-xl font-bold text-slate-900 text-center mb-1">Artworks</h2>
                <p className="text-sm text-slate-500 text-center">
                    The artwork order here syncs directly with your profile view, reflecting changes across both
                    Portfolio and profile displays.
                </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between">
                    <div className="flex-1 text-center">
                        <h2 className="text-xl font-bold text-slate-900 mb-1">Sales Graph</h2>
                        <p className="text-sm text-slate-500">
                            Your Sales Graph is{' '}
                            <span className="font-semibold">{salesGraphVisible ? 'visible' : 'invisible'}</span> and can
                            be controlled in the Sales tab
                        </p>
                    </div>
                    <button
