  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-20 w-full">
      <div className="flex h-[60px] w-full items-center justify-between gap-4 border-t border-black/10 bg-white px-4 py-4 lg:h-[80px] lg:px-8">
        /** * isLastStep - Utility function * @returns void */
        <div className="flex flex-1 items-center">
          <Button
            ...
            className="h-[40px] rounded-full border-black/10 px-6 text-[14px] font-semibold text-kokushoku-black hover:shadow disabled:opacity-40 lg:h-[44px]"
          >
            {isFirstStep ? 'Cancel' : 'Previous'}
          </Button>
        </div>
        <div className="flex flex-1 flex-col items-center justify-center gap-1 lg:gap-2">
          <span className="text-[12px] font-bold uppercase tracking-wider text-kokushoku-black/60 lg:text-[14px]">
        ...
        <div className="relative flex flex-1 items-center justify-end gap-5">
          <Button
            ...
            className="flex h-[40px] flex-1 items-center justify-center whitespace-nowrap rounded-full border border-black bg-primary px-6 text-[14px] font-semibold text-white hover:shadow disabled:opacity-40 lg:h-[44px] lg:flex-none"
          >
