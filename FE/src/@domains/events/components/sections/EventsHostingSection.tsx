 ...
 */
          <Select
            value={sortValue}
            onValueChange={(value) =>
              setSortValue(value as EventsHostingSortValue)
            }
          >
            <SelectTrigger
              aria-label="Sort events"
              className="h-10 cursor-pointer rounded-full border border-slate-200 bg-white px-4 text-[14px] font-semibold text-slate-900 shadow-none transition hover:border-slate-300 hover:bg-slate-50 focus:border focus:border-slate-200 focus-visible:border focus-visible:border-slate-200 focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0"
            >
              <SelectValue />
            </SelectTrigger>
 ...
 */
        ...
        <div className="mt-6 flex min-h-[240px] flex-col items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-6 py-10 text-center">
          ...
          <p className="max-w-[720px] text-sm text-slate-600">
            Create and manage upcoming exhibitions, openings, or art-related
            events.
          </p>
          <button
            type="button"
