...
export const EventFiltersBar = ({
  ...
  return (
    <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2">
      ...
      <div className="order-2 grid grid-cols-3 gap-2 md:order-1 md:flex md:flex-wrap md:items-center">
        ...
        <Select value={statusFilter} onValueChange={onStatusChange}>
          <SelectTrigger
            ...
            className="h-10 w-full cursor-pointer rounded-full border border-slate-200 bg-white px-3 font-inter text-[13px] font-semibold text-slate-900 shadow-none transition-colors hover:border-slate-300 hover:bg-slate-50 focus:!border focus:!border-slate-300 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 data-[state=open]:border-slate-300 data-[state=open]:bg-slate-50 md:w-fit"
          >
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="md:max-w-100 relative order-1 w-full md:order-2 md:ml-auto md:min-w-[160px] md:flex-1">
        ...
        <input
          ...
          className="h-11 w-full rounded-full border border-slate-200 bg-white pl-10 pr-4 font-inter text-[13px] text-slate-900 transition-colors placeholder:text-slate-400 hover:border-slate-300 focus:border-slate-300 focus:outline-none focus:ring-0"
        />
      </div>
    </div>
  )
