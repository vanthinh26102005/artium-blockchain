    ...
    >
      ...
      <div className="flex items-center gap-3">
        <span className="whitespace-nowrap text-[14px] font-medium text-slate-600">
          /** * canGoNext - Utility function * @returns void */ Items per page
        </span>
        <Select
        ...
        >
          <SelectTrigger
            ...
            className="h-10 w-[70px] cursor-pointer rounded-lg border border-slate-200 bg-white px-3 font-inter text-[14px] font-semibold text-slate-700 shadow-none transition-colors hover:bg-slate-50 focus:!border focus:!border-slate-300 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 data-[state=open]:border-slate-300 data-[state=open]:bg-slate-50"
            /**
              ...
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : 'cursor-pointer border-slate-200 bg-white text-slate-700 hover:bg-slate-50 hover:text-slate-900',
                )}
              >
                {page}
              </button>
