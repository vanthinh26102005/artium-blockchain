...
export const BuyerInformationForm = () => {
    return (
        <div className="rounded border border-slate-300 bg-slate-50 p-4">
            <p className="text-sm text-slate-500">BuyerInformationForm - Coming in PR2</p>
        </div>
    )
}
...
export const TaxAndShippingControls = () => {
    return (
        <div className="rounded border border-slate-300 bg-slate-50 p-4">
            <p className="text-sm text-slate-500">TaxAndShippingControls - Coming in PR2</p>
        </div>
    )
}
...
export const PaymentFormStripe = () => {
    return (
        <div className="rounded border border-slate-300 bg-slate-50 p-4">
