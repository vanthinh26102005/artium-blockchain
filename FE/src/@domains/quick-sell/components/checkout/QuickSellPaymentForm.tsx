    ...
    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-4">
          ...
          <div className="mt-4 grid gap-3">
            <div className="relative">
              <input
                type="text"
                disabled
                className="w-full cursor-not-allowed rounded border border-slate-300 bg-white px-3 py-2 text-sm text-slate-400"
        ...
        <div className="flex items-start gap-2 text-xs text-slate-500">
          ...
          <span>
            Payments are processed securely. This is a secure simulation environment. No real charge
            will be made.
          </span>
        </div>
        ...
        <Button
          ...
          className="w-full bg-blue-600 py-6 text-lg font-semibold transition-all hover:scale-[1.01] hover:bg-blue-700 disabled:opacity-50"
        >
          Pay {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(total)}
        </Button>

        {!isFormValid && (
          <p className="animate-pulse text-center text-sm text-amber-600">
