...
export const PricingFooter: React.FC = () => {
  return (
    ...
    <section className="bg-linear-to-b relative mb-[-96px] w-full overflow-hidden from-slate-900 via-slate-900 to-black pb-0 pt-20 sm:mb-[-112px]">
      {/* Background gradient overlay */}
      <div className="bg-linear-to-br absolute inset-0 from-blue-900/20 via-transparent to-purple-900/20" />

      <div className="relative mx-auto max-w-4xl px-4 pb-16 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <span className="text-sm text-slate-400">Try it now, cancel anytime</span>
        </div>
      </div>
