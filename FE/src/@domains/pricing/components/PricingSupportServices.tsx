...
export const PricingSupportServices: React.FC = () => {
  return (
    <div className="mt-16 px-6 py-16 lg:px-12">
      /** * PricingSupportServices - React component * @returns React element */
      {/* -- header -- */}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-3">
                /** * hasIncluded - Utility function * @returns void */
                ...
                {/* -- included info -- */}
                {hasIncluded ? (
                  <div className="flex items-center px-3 py-1 text-xs italic text-slate-500">
