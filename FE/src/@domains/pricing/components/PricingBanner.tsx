...
export const PricingBanner: React.FC = () => {
  return (
    <section
      className="bg-linear-to-r relative left-1/2 right-1/2 -mt-20 mb-16 w-screen -translate-x-1/2 overflow-hidden from-blue-400 via-sky-200 to-cyan-200 px-6 text-center shadow-lg md:px-12 lg:px-16"
      style={{ minHeight: '800px' }}
    >
      {/* -- content -- */}
      <div className="relative z-10 mt-10 flex h-full flex-col items-center justify-center space-y-8 py-20 md:py-28 lg:py-32">
        <h1 className="text-5xl font-black leading-tight text-[#191414] md:text-6xl lg:text-7xl">
        ...
        <div className="mt-6 flex flex-col items-center gap-4 sm:mt-8">
          ...
          <p className="text-base font-medium italic text-slate-600">Try 14 days, cancel anytime</p>
        </div>
      </div>

      {/* -- background effects -- */}
      <div className="absolute inset-0 opacity-60">
        <div className="absolute -left-20 -top-20 h-80 w-80 rounded-full bg-blue-400 blur-3xl" />
