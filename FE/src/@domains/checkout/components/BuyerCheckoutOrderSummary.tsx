    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-white p-6 shadow-sm">
        ...
        <div className="mb-6 flex gap-4">
          ...
          <div className="min-w-0 flex-1">
            <Link
              ...
              className="block truncate text-[16px] font-bold text-[#191414] transition hover:text-[#0066FF]"
            >
              {artwork.title}
            </Link>
            <Link
              href={`/profile/${artwork.artistId || artwork.artistName.toLowerCase().replace(/\s/g, '')}`}
              className="text-[14px] text-[#595959] transition hover:text-[#0066FF]"
            >
              {artwork.artistName}
            </Link>
          </div>
        ...
        <div className="space-y-3 border-t border-[#E5E5E5] pt-4">
          ...
          <div className="flex justify-between border-t border-[#E5E5E5] pt-3">
            ...
            <span className="text-[20px] font-bold text-[#191414]">
      ...
      <div className="space-y-4 rounded-3xl bg-white p-6 shadow-sm">
        ...
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="text-[14px] font-bold text-[#191414]">
