...
export const BuyerCheckoutLayout = ({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FDFDFD] font-sans text-[#191414]">
      {/* Header - Full Width */}
      /** * formatTime - Utility function * @returns void */
      <header className="fixed left-0 right-0 top-0 z-30 border-b border-black/10 bg-white">
      ...
      <div className="fixed left-0 right-0 top-[60px] z-20 border-b border-black/5 bg-[#F5F5F5] lg:top-[80px]">
      ...
      <main className="w-full px-4 pb-[100px] pt-[140px] lg:px-8 lg:pb-[120px] lg:pt-[160px]">
        <div className="grid w-full grid-cols-1 gap-8 lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_480px]">
          {/* Left Column - Forms */}
          <div className="space-y-6">{children}</div>

          {/* Right Column - Order Summary */}
          <div className="lg:sticky lg:top-[180px] lg:self-start">{orderSummary}</div>
        </div>
      </main>
