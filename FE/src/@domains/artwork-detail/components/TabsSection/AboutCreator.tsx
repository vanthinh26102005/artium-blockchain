...
export const AboutCreator = ({ creator }: AboutCreatorProps) => {
  ...
  return (
    <div className="flex items-start gap-4">
      /** * handleFollow - Utility function * @returns void */
      {/* Avatar */}
      <Link
        href={profileHref}
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2">
          ...
          >
            {creator.displayName}
            {creator.verified && <BadgeCheck className="h-5 w-5 text-amber-500" />}
          </Link>
          <Button
            variant="default"
            size="sm"
        ...
        {/* Stats */}
        <div
          className="mt-2 flex items-center gap-4 text-slate-500"
          style={{
            fontFamily: 'Inter',
            fontSize: '14px',
            lineHeight: '20px',
