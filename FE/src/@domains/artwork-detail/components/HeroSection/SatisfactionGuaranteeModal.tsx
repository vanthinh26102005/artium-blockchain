      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm leading-relaxed text-slate-600">
              ...
              <span className="text-amber-600">
                The refund will be in your account 5-7 days after Artium successfully receives the
                artwork.
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm leading-relaxed text-slate-600">
              Artium insures your order. If you select ship, shipping fee is calculated based on
              order subtotal (after discounts), and shows in the final total at checkout, with a
              flat fee of 5% for domestic, 8% for international. Oversized artworks will incur a
              flat fee of 10% for domestic, 15% for international shipping. If you select pick up
              in-person, it's free. Total at checkout excludes local customs duties, taxes, and
              import fees; your carrier may collect these on delivery.{' '}
            </p>
          </div>
