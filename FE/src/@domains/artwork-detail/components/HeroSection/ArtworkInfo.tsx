  ...
  return (
    <>
      <div className="flex flex-col space-y-5">
        {/* Title and Year */}
        <div>
          /** * handleMakeOffer - Utility function * @returns void */
          <h1
          ...
          >
            ...
            >
              ...
              {artwork.creator.verified && <BadgeCheck className="h-4 w-4 text-blue-500" />}
            </Link>
          </p>
        </div>
        ...
        <div className="space-y-3 border-t border-slate-200 pt-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              className="flex flex-1 items-center justify-center gap-2 rounded-full bg-blue-600 px-5 text-white transition hover:bg-blue-700"
      ...
      <SatisfactionGuaranteeModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
