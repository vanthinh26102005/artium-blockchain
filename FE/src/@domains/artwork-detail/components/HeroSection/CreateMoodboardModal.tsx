 ...
 */
export const CreateMoodboardModal = ({
  open,
  onOpenChange,
  onCreate,
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        className="max-w-md rounded-[28px] border border-slate-200 bg-white/95 p-6 shadow-[0_25px_70px_rgba(15,23,42,0.32)] backdrop-blur-3xl sm:p-7"
        overlayClassName="bg-slate-900/70 backdrop-blur-3xl backdrop-saturate-150"
      >
        <DialogHeader className="text-center">
          /** * handleCreateMoodboard - Utility function * @returns void */
