          ...
          >
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  artwork.isSold ? 'bg-red-50 text-red-600' : 'bg-white/90 text-slate-900',
                )}
              >
                <span
                  className={cn(
                    'h-2 w-2 rounded-full',
                    artwork.isSold ? 'bg-red-500' : 'bg-blue-500',
                  )}
                />
                <span className="leading-none">{artwork.isSold ? 'SOLD' : artwork.priceLabel}</span>
              </span>
            </Link>
            <div className="flex flex-1 flex-col space-y-2 p-4">
              ...
              <div className="mt-auto pt-2">
                <button
                  className={cn(
                    'w-full cursor-pointer rounded-full border px-3 py-2 text-sm font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none',
                    artwork.isSold
                ...
                >
                  {artwork.isSold ? 'See details' : 'Buy now'}
                </button>
              </div>
            </div>
          </div>
