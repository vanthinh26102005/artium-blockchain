...
import { mockArtworks, type DiscoverArtwork } from '@domains/discover/mock/mockArtworks'
...
export const ArtworksGrid = ({ isImageSearch, onExitImageSearch }: ArtworksGridProps) => {
  // -- state --
  const { displayedItems, isLoading, hasMore, loadMore } = useMockInfiniteScroll({
    allItems: mockArtworks,
    initialCount: 18,
    loadMoreCount: 12,
  })
