  ...
  const popoverContent = (
    <PopoverPrimitive.Content
      ...
      className={cn(
        ...
        'pointer-events-auto rounded-[12px] border-[0.75px] border-[rgba(0,0,0,0.10)] border-[solid] bg-[rgba(253,_253,_253,_0.80)] [box-shadow:0px_3px_7.5px_0px_rgba(0,_0,_0,_0.15),_0px_0px_15px_0px_rgba(0,_0,_0,_0.10)] backdrop-blur-[18.75px] backdrop-filter',
        className,
      )}
      {...props}
    />
